// Om Kulturfestivalen och föreningarna bakom festivalen
// Den eritreanska festivalen i Stockholm är en årlig kulturfestival som i år kommer att hållas för
// 25:e gången, 28–31 juli vid Eggebygård vid Järvafältet. Festivalen är den största eritreansk
...
// stolthet över sin identitet. Festivalen arrangeras av den eritreanska festivalkommittén, National
...
// eritreanska ungdomsföreningen och kvinnoföreningen. I rådet ingår även representanter för flera
...
// man åt för att täcka underskottet. Det är tack vare de hundratals eldsjälar och kreativa
// föreningsmedlemmar som festivalen kan fortsätta arrangeras trots de stora ekonomiska och
// logistiska utmaningarna. Det är en folkrörelse i ordets sanna bemärkelse som står bakom festivalen
...
// som människa och känna stolthet över vem man är. Festivalen har fokus på livskvalitet och
// arrangerar olika moment gällande idrott, integration och kultur. Festivalprogrammet är omfattande och innehåller en lång rad kulturella inslag, seminarier, debatter, aktiviteter för barn och ungdomar, kulturshower med artister från Eritrea och diasporan, sångtävling, idrottstävlingar, tivoli, basar, konst, dans och mat i olika former.

// 16 föreningar och flera företag deltog med eget tält
...
// hade egna tält. Specialistbutiker från Stockholm erbjöd produkter som normal inte finns i vanliga butiker.
...
// Bred och engagerande kulturevenemang
...
// kulturgrupp från Eritrea bestående av 9 personer som satte folk på dansande fötter i 4 dagar. Att nämna några av ett fullspäckat program: presentation av ny utgivna böcker där 4 författare fick
// presentera sina böcker; en dramapjäs av en erkända författare och skådespelare iscensattes; en
// konstutställning samt fotoutställning av journalisten Donald Boström visades på ett tält.
// Kulturfestivalen har i sitt program alltid inslag av samhällsinformation och samhällsengagerade ämnen
// genom att inbjuda föreläsare. En viktig del av detta är den som en representant för den eritreanska
// regeringen håller i. Det är ett mycket betydelsefullt tillfälle för festivalbesökarna att ha dialog, ventilera
// sina åsikter och ställa frågor om sitt ursprungsland Eritrea. I år var det administrativa Chefer för landets
// alla 6 regioner som ingående berättade om nuvarande och framtida utvecklingsplan i regionerna.
...
// hörd och om hur viktigt det är att gå och rösta i åretsval, 15 september 2022. Barnen uppskattade den årligen återkommande populära artisten Tekle Clown som underhåll dem
// uttröttlig i fyra dagar. Barnen hade dessutom egen aktivitets tält samt karusell och lekpark.

// En fredlig festival som drivs av volontärer
// Eritrea kulturfestival drivs av frivillig engagerade funktionärer och ideella föreningar. Utan alla dessa
// människor som oavlönad ställer upp skulle vi inte kunna genomföra festivalen i åratal. Det är glädjande
...
// för ett mycket gott samarbete. Vi har varken ekonomisk eller juridisk anmärkning hos någon myndighet,
// inklusive Järva Folketshus.

// Staden bör uppmuntra kulturfestivalen
...
// samhällsinformation, skapar samtal och uppmuntrar till positiv engagemang i samhällslivet. Vi tror stark
// kulturfestivalen bidrar till bättre informerade och välmående medborgare.
...
// Eritrea Festival i Stockholm lockade över 10 000 besökare
...
// nordisk och europeisk händelse. Den har satt Järva och Stockholm på kartan. Vi är mycket glada att vi
