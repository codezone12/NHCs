...
import { FaCalendarAlt, FaMapMarkerAlt, FaUsers, FaHandshake, FaGlobe, FaMusic, FaChild, FaBook, FaComments, FaHeart, FaLightbulb, FaUniversity, FaTheaterMasks, FaUtensils, FaChevronLeft, FaChevronRight, FaQuoteLeft, FaQuoteRight, FaUser, FaPhotoVideo } from 'react-icons/fa';
...
const SubPage = () => {
  ...
  const facts = [
    ...
    },
    {
      ...
      content: "Festivalen bedrivs ideellt utan vinstintresse och förlitar sig på frivillig arbetskraft och ekonomiska bidrag från medverkande föreningar."
    }
  ];
                ...
                <div className="w-full" data-aos="fade-up" data-aos-delay="100">
                  <div className="w-full p-3 bg-white shadow-lg rounded-lg">
                    <div className="w-full max-h-64 rounded-lg overflow-hidden">
                      <ImagePreview 
                        src="/images/festival-page/IMG_6851.JPG"
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <div className="relative border-l-4 border-blue-500 pl-8 py-4 ml-4 space-y-8 before:content-[''] before:absolute before:top-0 before:left-0 before:w-4 before:h-4 before:bg-blue-500 before:rounded-full before:-ml-2">
                <div className="relative" data-aos="fade-left">
                  ...
                  <h3 className="flex text-lg font-bold text-blue-900 mb-2"><FaBook className='mr-2 mt-[4px] text-blue-600' />Litteratur & Konst</h3>
        ...
        <div className="mt-6 grid md:grid-cols-2 gap-6">
          <div className="p-4 bg-blue-50 rounded-lg">
            ...
            <div className="space-y-2 text-gray-700">
              <p><strong>Tunnelbana:</strong> Blå linje till Akalla eller Hjulsta</p>
              <p><strong>Buss:</strong> Från Akalla/Hjulsta till Järvafältet</p>
              <p className="text-sm text-blue-600">Rekommenderat: Använd SL-appen för aktuella tider</p>
            </div>
          </div>
          ...
          <div className="p-4 bg-green-50 rounded-lg">
            ...
            <div className="space-y-2 text-gray-700">
              <p><strong>Från E4/E18:</strong> Följ skyltarna mot Järvafältet</p>
              <p><strong>Parkering:</strong> Tillgänglig vid Eggebygård</p>
              <p className="text-sm text-green-600">Tips: Kom tidigt för bästa parkeringsplatser</p>
            </div>
          </div>
        </div>
