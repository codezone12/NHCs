          ...
          <div className="w-full lg:w-1/2 flex flex-wrap justify-center gap-8 mb-8 lg:mb-10">
            ...
            <div className="flex gap-4 justify-center md:justify-around w-full">
              ...
              <div className="w-[30%] rounded-lg overflow-hidden md:translate-y-[40px]  hover:scale-105 duration-300 shadow-lg shadow-black">
                <ImagePreview 
                  src="/images/newImages/IMG_2797.JPG" 
                  alt="Person reading" 
                  className="w-full h-full object-cover"
                />
              </div>
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
              <div className="flex flex-col items-center lg:items-start">
                <div className="bg-blue-600 p-3 rounded mb-4 relative overflow-hidden cursor-pointer transform transition-all duration-300 hover:bg-blue-700 hover:scale-110 hover:shadow-lg group">
                  <span className="absolute inset-0 w-full h-full bg-white/30 scale-0 rounded-full transition-all duration-500 group-hover:scale-[2.5] group-hover:opacity-0"></span>
