    ...
    <header className="sticky top-0 left-0 right-0 z-20 bg-gray-500/30 backdrop-blur-md">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center space-x-6">
          ...
          <a href="/about" className="text-white hover:text-blue-200 transition">About Us</a>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-blue-900/80 backdrop-blur-md">
          ...
          <a href="/about" className="block p-4 text-white hover:bg-blue-800/50">About Us</a>
          <a href="/news" className="block p-4 text-white hover:bg-blue-800/50">News Feed</a>
          <a href="/contact" className="block p-4 text-white hover:bg-blue-800/50">Contact Us</a>
