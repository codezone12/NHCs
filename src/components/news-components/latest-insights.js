        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 relative">
              ...
              {/* Post 5 */}
              <div className="relative flex bg-gray-900 rounded overflow-hidden">
              <img src="/images/cr_mining_post02.jpg.png" alt="Blockchain" className="w-full h-40 object-cover" />
                <div className="absolute top-2 left-2 bg-yellow-500 text-black text-xs px-2 py-1 rounded">BITCOIN</div>
                <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black to-transparent">
                  <h4 className="text-sm font-medium">Racing Games Browned Butte Roadert Cookies Daily Breakfast</h4>
                  <span className='flex gap-8'>
                    <div className="flex items-center mt-2 text-xs text-gray-300">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-3 w-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
          ...
          <div className="lg:col-span-1">
            <div className="rounded p-4 mb-4">
              ...
              <div className="space-y-4">
                {/* Featured Item 1 */}
                <div className="flex items-start space-x-3 border-b-2 border-yellow-500 pb-3">
                  <div className="flex-shrink-0">
                    <img src="/images/bitcoin-image.png" alt="Business meeting" className="w-16 h-16 object-cover rounded" />
                  </div>
                  <div>
                    <div className="mb-1">
                      <span className="bg-yellow-400 text-black text-xs px-2 py-0.5 rounded">Business</span>
                    </div>
                ...
                {/* Featured Item 2 */}
                <div className="flex items-start space-x-3 border-b-2 border-yellow-500 pb-2">
                  <div className="flex-shrink-0">
                    <img src="/images/cr_trending_post05.jpg.png" alt="Security" className="w-16 h-16 object-cover rounded" />
                  </div>
                  <div>
                    <div className="mb-1">
                      <span className="bg-yellow-400 text-black text-xs px-2 py-0.5 rounded">Security</span>
                    </div>
                ...
                <div className="flex items-start space-x-3 border-b-2 border-yellow-500 pb-3">
                  ...
                  <div>
                    <div className="mb-1">
                      <span className="bg-yellow-400 text-black text-xs px-2 py-0.5 rounded">Design</span>
                    </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <div className="mb-1">
                      <span className="bg-yellow-400 text-black text-xs px-2 py-0.5 rounded">Recipes</span>
                    </div>
