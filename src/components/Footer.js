...
const Footer = () => {
  ...
  const handleNewsletterSubmit = async (e) => {
    ...
    try {
      ...
      // Error is already handled by the service function with toast
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10 mb-12">
          ...
          <div className="w-full lg:w-1/3">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-2 mb-3">
              <input 
                type="email" 
          ...
          <div className="w-full sm:w-auto">
            ...
            <ul className="space-y-2">
              {[
                ...
                { href: "https://www.erfis.org", target: "_blank", text: "Emash - ERFIS" },
              ].map((link, index) => (
                <li key={index}>
                  {link.isButton ? (
                    <button 
                    ...
                    <a href={link.href} target={link.target === "_blank" ? "_blank" : "_self"} className="text-sm text-gray-300 hover:text-yellow-500 transition relative inline-block group">
                      {link.text}
                      <div className="absolute bottom-0 left-0 w-0 h-0.5 bg-yellow-400 transition-all duration-300 ease-in-out group-hover:w-full"></div>
                    </a>
                  )}
